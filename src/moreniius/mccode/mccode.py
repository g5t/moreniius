...
class NXMcCode:
    ...
    #     if (
    #         transformations and (nxtrans := nxinst.nx.get('transformations')) is not None
    #         and nxtrans != transformations and name in self.orientations.keys()
    #     ):
    #         # if the component modified the transformations group,
    #         # make sure we don't use our version again
